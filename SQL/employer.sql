...
create table employee_position(
	...
	employee_id int,
	position_id int,
	constraint employee_position_fkey foreign key (employee_id) references employee(id),
	constraint position_empolye_fkey foreign key (position_id) references position(id)
);
...
create table leave_request(
	...
	end_date date,
	reason varchar(100),
	constraint employe_leave_fkey foreign key (employee_id) references employee(id),
...
create table travel_request(
	...
	start_date date,
	end_date date,
	constraint employe_travel_fkey foreign key (employee_id) references employee(id),
	constraint travel_type_fkey foreign key (travel_type_id) references travel_type(id)
);
...
create table travel_settlement(
	...
	item_cost int,
	constraint travel_req_fkey foreign key (travel_request_id) references travel_request(id)
);
