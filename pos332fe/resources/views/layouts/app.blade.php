...
<head>
    ...
    <title>{{ config('app.name', 'Pos-332') }}</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('category') }}">Category</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="/varian">Varian</a>
                        </li>
                        <li class="nav-item">
